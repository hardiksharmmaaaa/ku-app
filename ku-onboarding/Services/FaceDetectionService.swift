...
//
//  Note on orientation: CameraService pins the video-data connection to
//  .portrait, so buffers arrive upright and no orientation hint is needed
//  here. That pin must be re-applied after a camera switch — see
